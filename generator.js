...
function GenerateNewText() {
  ...
  this.sentences =
    ["These go to 11.",
      ...
      "Vixen.Joan Jett.Doro.",
      "Back of the tour bus.",
      "Slaughter Fly to the Angels.",
      "There's a lady who's sure all that glitters is gold.",
      "Led Zeppelln.Kingdom Come.Greta Van Fleet.",
      ...
      "Joan Jett and the Blackhearts.Lita Ford.",
